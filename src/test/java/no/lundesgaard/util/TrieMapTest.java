...
public class TrieMapTest {
    ...
    public void testMap() {
        ...
        Map.Entry<String, String> trieMapEntry = trieMap.entrySet().iterator().next();
        Iterator<Map.Entry<String, String>> anotherMapIterator = anotherMap.entrySet().iterator();
        Map.Entry<String, String> anotherMapEntry = anotherMapIterator.next();
        assertEquals(anotherMapEntry, trieMapEntry);
        assertEquals(trieMapEntry, anotherMapEntry);
        assertEquals(trieMapEntry, trieMapEntry);
        Map.Entry<String, String> yetAnotherMapEntry = anotherMapIterator.next();
        assertNotEquals(trieMapEntry, yetAnotherMapEntry);
